...
pkgdatadir = $(datadir)/smaug
pkgincludedir = $(includedir)/smaug
pkglibdir = $(libdir)/smaug
pkglibexecdir = $(libexecdir)/smaug
...
CONFIG_HEADER = $(top_builddir)/src/smaug.h
CONFIG_CLEAN_FILES = smaug-2.0.pc Doxyfile
...
am__DIST_COMMON = $(srcdir)/Doxyfile.in $(srcdir)/Makefile.in \
	$(srcdir)/smaug-2.0.pc.in ABOUT-NLS AUTHORS COPYING ChangeLog \
...
ACLOCAL = ${SHELL} '/home/anthonyderosia7/_smaug_/missing' aclocal-1.16
...
AR = ar
AUTOCONF = ${SHELL} '/home/anthonyderosia7/_smaug_/missing' autoconf
AUTOHEADER = ${SHELL} '/home/anthonyderosia7/_smaug_/missing' autoheader
AUTOMAKE = ${SHELL} '/home/anthonyderosia7/_smaug_/missing' automake-1.16
AWK = gawk
BASH = /bin/bash
CC = gcc
CCAS = gcc
...
CFLAGS = -g -O2 -fomit-frame-pointer -Wno-all -Wno-cast-align -Wno-unused-result -Wno-write-strings -Wno-unused-but-set-variable -Wno-pointer-to-int-cast -Wno-address -Wno-int-to-pointer-cast -Wno-uninitialized
CPP = cpp
CPPFLAGS = 
CSCOPE = cscope
CTAGS = ctags
...
DEPDIR = .deps
DESCRIPTION = --{ SMAUG II }-- MUD Server
DLLTOOL = false
DOXYGEN = 
DSYMUTIL = 
DUMPBIN = 
...
LDFLAGS =  -lcrypt -finline-functions -funroll-loops -fdefer-pop -fstrength-reduce
LEX = :
LEXLIB = 
LEX_OUTPUT_ROOT = 
LIBICONV = -liconv
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/home/anthonyderosia7/_smaug_/missing' makeinfo
MANIFEST_TOOL = :
...
OTOOL64 = 
PACKAGE = smaug
PACKAGE_BUGREPORT = <@burzumishi>
PACKAGE_NAME = smaug
PACKAGE_STRING = smaug 2.0.0
PACKAGE_TARNAME = smaug
PACKAGE_URL = 
...
abs_builddir = /home/anthonyderosia7/_smaug_
abs_srcdir = /home/anthonyderosia7/_smaug_
abs_top_builddir = /home/anthonyderosia7/_smaug_
abs_top_srcdir = /home/anthonyderosia7/_smaug_
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/anthonyderosia7/_smaug_/install-sh
...
$(am__aclocal_m4_deps):
smaug-2.0.pc: $(top_builddir)/config.status $(srcdir)/smaug-2.0.pc.in
...
install-data-hook:
	@echo "Creating <smaug> directory to store log files ..."; \
	mkdir -pv $(localstatedir)/log/smaug; \
	echo "Creating <smaug> directories to store lock and run files ..."; \
	mkdir -pv $(localstatedir)/lock/smaug; \
	mkdir -pv $(localstatedir)/run/; \
	echo "Installing <smaug> Database files ..."; \
	mkdir -pv $(sharedstatedir)/smaug; \
	cp -rvf db/* $(sharedstatedir)/smaug; \
	echo "Installing <smaug> Website files ..."; \
	mkdir -pv $(localstatedir)/www/smaug; \
	cp -rvf www/* $(localstatedir)/www/smaug; \
	...
	echo ""; \
	echo "<smaug> has ben installed to <$(prefix)> directory!"; \
